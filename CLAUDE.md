...
**no-clip slack at the 992px breakpoint, re-verify after ANY nav/brand
change** — re-verified 2026-06-11 after the palette wiring: no clip, ~10px slack
on the strictest measure [rightmost element incl. the navbar search tool vs the
container content edge; the earlier "39px" figure didn't count the ~30px search
tool]). Tab/SEO title + landing H1 + footer + chart attribution = Canada
